...
public class Queue_03 {
    public static void main(String[] args) {
        ...
        // ?Approch1 : Push Efficient
        System.out.println("<==========Implement queue using Stacks(Push Efficient)==========>");
        implemQByStacPush iqspush = new implemQByStacPush();
        iqspush.add(1);
        iqspush.add(2);
        iqspush.add(3);
        iqspush.add(4);
        iqspush.display();
        System.out.println("Peek element of stack is : " + iqspush.top());
        iqspush.display();
        System.out.println("Pop element from stack as Queue is : " + iqspush.pop());
        System.out.println("Peek element of stack is : " + iqspush.top());
        iqspush.display();
    }
}
